...
export function About(){
    return(
        <section className="bg-[#fdf6ec] py-16 mt-10">
            <div className="container mx-auto">

              <div className="grid cols-1 ld: grid-cols-2 gap-12 items-center px-4">
            ...
            <a href="#"
                className="bg-black text-white font-semibold flex items-center justify-center w-fit gap-2 px-4 py-2 rounded-sm"
                >
                ...
                <a href="#"
                className="font-semibold flex items-center justify-center w-fit gap-2 px-4 py-2 rounded-sm"
                >
